...
One page per module, linked from each module's own README.md.

| Page                         | Covers                                                                      |
| ---------------------------- | --------------------------------------------------------------------------- |
| [`decklist.md`](decklist.md) | parsing and resolving a decklist                                            |
| [`metrics.md`](metrics.md)   | every metric definition — the source for `/methodology`                     |
